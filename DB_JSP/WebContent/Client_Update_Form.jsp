		    ...
		    <article class="half">
			        ...
			        <div class="content">				       
    				        <div class="signup-cont cont">
             					   <form action="Client_Update.jsp?whr=<%=whr%>" method="post">
             					   			<input type="hidden" name="no" value="<%=no%>">
             					   			<input type="text" name="name" id="name" class="inpt" required="required" value="<%=client.getName()%>">
						                    <label for="name">Your name</label>
						                    <input type="email" name="email" id="email" class="inpt" required="required" value="<%=client.getEmail()%>">
						                    <label for="email">Your email</label>
						                    <input type="password" name="password" id="password" class="inpt" required="required" value="<%=client.getPassword()%>">
                						    <label for="password">Your password</label>
                						    <input type="tel" name="phone" id="phone" class="inpt" required="required" value="<%=client.getPhone()%>">
                						    <label for="phone">Your phone</label>
                						    <input type="number" name="age" id="age" class="inpt" required="required" value="<%=client.getAge()%>">
