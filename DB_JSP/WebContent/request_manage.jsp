...
<%
	...
	List<RequestDTO> list = manager.getList();
...
<div class="menu">
 <ul class="nav nav-tabs">
  ...
  <li role="presentation" class="active"><a href="request_manage.jsp">요청관리</a></li>
...
<span class="label label-success">작업완료</span>
<span class="label label-info">작업중</span>
...
<tbody>
	...
	<tr class="info">
		...
		<td><a href="Request_Update_Form.jsp?no=<%=data.getNo()%>">수정</a></td>
		<td><a href="Request_Delete.jsp?no=<%=data.getNo()%>">삭제</a></td>
	</tr>
	<%
		}
	%>
	<%
		if(data.getRespond().equals("작업완료")){
	%>
	<tr class="success">
		<td><%=data.getNo()%></td>
		<td><%=data.getRoom()%></td>
	...
	%>
	<tr>
		<td colspan="8" align="right"><input type="button" value="요청등록" onclick="location.href='Request_Add_Form.jsp'"></td>
	</tr>
</tbody>
</table>
<nav>
