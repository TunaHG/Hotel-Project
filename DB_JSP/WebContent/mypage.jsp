...
<p class="text">나이:</p>
<p class="text">성별:</p>
<a href="Client_Update_Form.jsp?no=<%=client.getNo()%>&whr=1">수정</a>

		    </div>
		    <div class="half bg">
<p class="text"><%=client.getName()%></p>
<p class="text"><%=client.getEmail()%></p>
<p class="text"><%=client.getPhone()%></p>
<p class="text"><%=client.getAge()%></p>
<p class="text"><%=client.getSex()%></p>
<a href="Client_Delete.jsp?no=<%=client.getNo()%>&whr=1">탈퇴</a>
		    </div>
	</section>
