		    ...
		    <article class="half">
			        ...
			        <div class="content">				       
    				        <div class="signup-cont cont">
             					   <form action="Request_Add.jsp" method="post">
						                    <input type="text" name="room" id="room" class="inpt" required="required" placeholder="Room">
						                    <label for="room">Room</label>
						                    <input type="text" name="content" id="content" class="inpt" required="required" placeholder="content" style="height: 120px;">
                						    ...
                						    <input type="text" name="ing" id="ing" class="inpt" required="required" placeholder="ing">
