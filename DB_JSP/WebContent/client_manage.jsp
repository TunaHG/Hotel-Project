...
<%
	...
	List<ClientJoinDTO> list = manager.getList();
...
<div class="menu">
 <ul class="nav nav-tabs">
  ...
  <li role="presentation" class="active"><a href="client_manage.jsp">고객관리</a></li>
...
<tbody>
	<tr>
		...
		<td><a href="Client_Update_Form.jsp?no=<%=data.getNo()%>&whr=2">수정</a></td>
		<td><a href="Client_Delete.jsp?no=<%=data.getNo()%>&whr=2">탈퇴</a></td>
	</tr>
	<%
		}
	%>
