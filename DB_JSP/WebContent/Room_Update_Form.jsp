...
<%
	...
	RoomDTO room = manager.getRoom(no);
%>
<html>
<head>
<meta charset="utf-8">
...
<section class="container">
		    <article class="half">
			        <h1>UIJO</h1>
			        <div class="tabs">
				            <span class="tab signup active"><a href="#signup">Modify</a></span>
				    </div>
			        <div class="content">				       
    				        <div class="signup-cont cont">
             					   <form action="Room_Update.jsp" method="post">
             					   			<input type="hidden" name="no" value="<%=no%>">
						                    <input type="text" name="roomno" id="roomno" class="inpt" required="required" value="<%=room.getRoomno()%>">
						                    <label for="room">Room Number</label>
						                    <input type="text" name="type" id="type" class="inpt" required="required" value="<%=room.getType()%>">
						                    <label for="room">Room Type</label>
						                    <input type="text" name="usee" id="usee" class="inpt" required="required" value="<%=room.getUsee()%>">
						                    <label for="room">Room Using</label>
						                    <input type="text" name="tow" id="tow" class="inpt" required="required" value="<%=room.getTow()%>">
						                    <label for="room">Room Towel Count</label>
						                    <input type="text" name="bed" id="bed" class="inpt" required="required" value="<%=room.getBed()%>">
						                    <label for="room">Room Bed Count</label>
						                    <input type="text" name="amenity" id="amenity" class="inpt" required="required" value="<%=room.getAmenity()%>">
						                    <label for="room">Room Amenity</label>
