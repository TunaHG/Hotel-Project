...
<%
	...
	RequestDTO req = manager.getRequest(no);
%>
<html>
<head>
<meta charset="utf-8">
		    ...
		    <article class="half">
			        ...
			        <div class="content">				       
    				        <div class="signup-cont cont">
             					   <form action="Request_Update.jsp" method="post">
             					   			<input type="hidden" name="no" value="<%=no%>">
						                    <input type="text" name="room" id="room" class="inpt" required="required" value="<%=req.getRoom()%>">
						                    <label for="room">Room</label>
						                    <input type="text" name="content" id="content" class="inpt" required="required" value="<%=req.getContent()%>" style="height: 120px;">
						                    <label for="content">Content</label>
						                    <input type="text" name="respond" id="respond" class="inpt" required="required" value="<%=req.getRespond()%>">
                						    <label for="ing">Respond</label>
                						    <input type="text" name="ing" id="ing" class="inpt" required="required" value="<%=req.getIng()%>">
