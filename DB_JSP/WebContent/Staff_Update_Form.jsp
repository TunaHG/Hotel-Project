...
<%
	...
	StaffJoinDTO stf = manager.getStaffJoin(no);
%>
<html>
<head>
<meta charset="utf-8">
		    ...
		    <article class="half">
			        ...
			        <div class="content">				       
    				        <div class="signup-cont cont">
             					   <form action="Staff_Update.jsp" method="post">
             					   			<input type="hidden" name="no" value="<%=no%>">
             					   			<input type="text" name="name" id="name" class="inpt" required="required" value="<%=stf.getName()%>">
						                    <label for="name">Your name</label>
						                    <input type="email" name="email" id="email" class="inpt" required="required" value="<%=stf.getEmail()%>">
						                    <label for="email">Your email</label>
						                    <input type="password" name="password" id="password" class="inpt" required="required" value="<%=stf.getPassword()%>">
                						    <label for="password">Your password</label>
                						    <input type="tel" name="phone" id="phone" class="inpt" required="required" value="<%=stf.getPhone()%>">
                						    <label for="phone">Your phone</label>
                						    <input type="number" name="age" id="age" class="inpt" required="required" value="<%=stf.getAge()%>">
