...
<section class="container">
		    <article class="half">
			        <h1>UIJO</h1>
			        <div class="tabs">
				            <span class="tab signup active"><a href="#signup">Pay</a></span>
				    </div>
			        <div class="content">				       
    				        <div class="signup-cont cont">
             					   <form action="Pay_Add.jsp" method="post">
						                    <input type="text" name="phone" id="phone" class="inpt" required="required" placeholder="Phone">
						                    <label for="room">User Phone</label>
						                    <input type="text" name="item" id="item" class="inpt" required="required" placeholder="Item">
						                    <label for="room">Item</label>
						                    <input type="text" name="price" id="price" class="inpt" required="required" placeholder="Price">
						                    <label for="room">Price</label>
						                    <input type="text" name="respond" id="respond" class="inpt" required="required" placeholder="respond">
						                    <label for="room">Respond</label>
