		    ...
		    <article class="half">
			        ...
			        <div class="content">				       
    				        <div class="signup-cont cont">
             					   <form action="Room_Add.jsp" method="post">
						                    <input type="text" name="roomno" id="roomno" class="inpt" required="required" placeholder="Room Number">
						                    <label for="roomno">Room Number</label>
						                    <input type="text" name="type" id="type" class="inpt" required="required" placeholder="Room Type">
						                    <label for="type">Room Type</label>
						                    <input type="text" name="usee" id="usee" class="inpt" required="required" placeholder="Room Using">
						                    <label for="usee">Room Using</label>
						                    <input type="text" name="tow" id="tow" class="inpt" required="required" placeholder="Room Towel Count">
						                    <label for="tow">Room Towel Count</label>
						                    <input type="text" name="bed" id="bed" class="inpt" required="required" placeholder="Room Bed Count">
						                    <label for="bed">Room Bed Count</label>
						                    <input type="text" name="amenity" id="amenity" class="inpt" required="required" placeholder="Room Amenity">
						                    <label for="amenity">Room Amenity</label>
